          ...
          child: Column(
            ...
            children: [
              ...
              OutlineButton.icon(
                ...
                icon: Icon(CommunityMaterialIcons.spotify, color: spotifyGreen,),
                label: Text('Open in Spotify'),
                highlightedBorderColor: spotifyGreen,
              ),
              SizedBox(
              ...
              OutlineButton.icon(
                ...
                icon: Image.asset('assets/google_podcast.png', height: 20,),
              ...
              OutlineButton.icon(
                onPressed: () async {
                  ...
                  if (await canLaunch(url)) {
                    ...
                    await launch(
                        'https://soundcloud.com/southside-presbyterian');
                  }
                },
                icon: Image.asset('assets/google_podcast.png', height: 20,),
                label: Text('Open Podcast'),
              ...
              OutlineButton.icon(
                ...
                icon: Icon(CommunityMaterialIcons.soundcloud, color: soundcloudOrange,),
